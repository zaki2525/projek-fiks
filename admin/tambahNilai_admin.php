        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0"><a
                ...
                <div class="text-center d-none d-md-inline"><a class="btn btn-warning" role="button"
                        style="width: 40px;height: 40px;margin: 0px;padding: 0px;" href="dtsiswa_nilai_admin.php"><i
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col offset-lg-0">
                                    <form><input class="form-control" type="number" style="width: 174.8px;" name="nip"
                                            placeholder="Masukkan NISN"></form>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-3 offset-lg-3" style="width: 69.5px;font-weight: bold;"><label
                            ...
                            <div class="row">
                                ...
                                <div class="col offset-lg-0">
                                    <form><input class="form-control" type="number" style="width: 174.8px;" name="pwpb"
                                            placeholder="Masukkan nilai"></form>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-3 offset-lg-3" style="width: 69.5px;"><label class="col-form-label"
                                        style="width: 61px;font-weight: bold;">PBO</label></div>
                                <div class="col offset-lg-0">
                                    <form><input class="form-control" type="number" style="width: 174.8px;" name="pwpb"
                                            placeholder="Masukkan nilai"></form>
                                </div>
